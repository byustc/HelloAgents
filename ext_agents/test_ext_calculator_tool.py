# test_ext_calculator_tool.py
from dotenv import load_dotenv
from ext_calculator_tool import create_calculator_registry
...
def test_calculator_tool():
    ...
    for i, expression in enumerate(test_cases, 1):
        ...
        result = registry.execute_tool("ext_calculator_tool", expression)
        print(f"结果: {result}\n")
...
def test_with_simple_agent():
    ...
    # 使用工具计算
    calc_result = registry.execute_tool("ext_calculator_tool", "sqrt(16) + 2 * 3")
